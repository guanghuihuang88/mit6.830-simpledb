...
public class StringAggregator implements Aggregator {
    ...
    public OpIterator iterator() {
        // some code goes here
        return new StringAggregator.Itr();
    ...
    class Itr implements OpIterator {
        ...
        public Tuple next() throws DbException, TransactionAbortedException, NoSuchElementException {
            ...
            if (what == Aggregator.Op.MIN) {
                if (gbfield == -1) {
                    StringField next = (StringField) iter.next();
                    IntField min = new IntField(Integer.parseInt(next.getValue()));
                    while (iter.hasNext()) {
                        IntField curValue = new IntField(Integer.parseInt(((StringField) iter.next()).getValue()));
                    ...
                    StringField next = (StringField) aggValues.next();
                    IntField min = new IntField(Integer.parseInt(next.getValue()));
                    while (aggValues.hasNext()) {
                        IntField curValue = new IntField(Integer.parseInt(((StringField) aggValues.next()).getValue()));
                        if (curValue.getValue() < min.getValue()) {
                            min = curValue;
                        }
                    }
            ...
            if (what == Aggregator.Op.MAX) {
                if (gbfield == -1) {
                    StringField next = (StringField) iter.next();
                    IntField max = new IntField(Integer.parseInt(next.getValue()));
                    while (iter.hasNext()) {
                        IntField curValue = new IntField(Integer.parseInt(((StringField) iter.next()).getValue()));
            ...
            if (what == Aggregator.Op.SUM) {
                if (gbfield == -1) {
                    StringField next = (StringField) iter.next();
                    IntField sum = new IntField(Integer.parseInt(next.getValue()));
                    while (iter.hasNext()) {
                        IntField curValue = new IntField(Integer.parseInt(((StringField) iter.next()).getValue()));
